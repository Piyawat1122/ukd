-----------เคดิตคนเเจก aExeur#4748 เปลื่ยนขอให้พ่อมึงตาย-----------
...
function LoadSettings()
	if readfile and writefile and isfile and isfolder then
		...
		if not isfile("MOCHI KING Premium Scripts/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json") then
			...
			local Decode = game:GetService("HttpService"):JSONDecode(readfile("MOCHI KING Premium Scripts/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json"))
